...
class UpdateRetailerScreen extends StatefulWidget {
  final Map<String, dynamic> currentRetailerData;

  const UpdateRetailerScreen({Key? key, required this.currentRetailerData})
      : super(key: key);

  @override
  State<UpdateRetailerScreen> createState() => _UpdateRetailerScreenState();
}

class _UpdateRetailerScreenState extends State<UpdateRetailerScreen> {
  String? _role;
  String _userId = "";
  String _companyId = "";
  String? _base64Image;
  ...
  Future<void> _initializeUserData() async {
    _nameController.text = widget.currentRetailerData["Name"];
    _phoneController.text = widget.currentRetailerData["Phone"];
    _companyController.text =
        ''; // Replace with actual company data if available
    _emailController.text = widget.currentRetailerData["email"];
  ...
  Future<void> handleAddNewRetailer(BuildContext context) async {
    ...
    var params = {
      ...
      "image": _base64Image,
      "edituserid": widget.currentRetailerData["userId"]
    };
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _buildTextField(
                        _nameController, 'Name', 'Enter Retailer Name'),
                    const SizedBox(height: 20),
                    _buildTextField(
                        _phoneController, 'Phone', 'Enter Retailer Contact'),
                    const SizedBox(height: 20),
                    _buildTextField(_companyController,
                        'Choose Retailer Company', 'cmpny_112200564'),
                    const SizedBox(height: 20),
                    _buildTextField(
                        _emailController, 'Email', 'Enter Retailer Email'),
                    const SizedBox(height: 20),
                    ElevatedButton.icon(
                      onPressed: () {
